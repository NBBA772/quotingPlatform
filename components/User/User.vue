...
const props = defineProps({
  isLoggedIn: {
    type: [Boolean, Object], // Accept either a plain boolean or a ref
    default: false,
  },
})

// Unwrap computed/ref if needed
const isLoggedIn = computed(() =>
  typeof props.isLoggedIn === 'object' ? props.isLoggedIn.value : props.isLoggedIn
)
